...
<head>
    ...
    <title>GoPartner Lite - Riwayat Pesanan</title> 
    ...
    <style>
        ...
        .order-card:hover {
         ...
         .order-card--completed {
             border-left: 6px solid var(--gojek-green); 
         }
          .order-card--completed .order-card-header {
             background-color: var(--gojek-green-light);
          }

         .order-card--cancelled {
              border-left: 6px solid var(--gojek-red); 
         }
          .order-card--cancelled .order-card-header {
        ...
        @media (max-width: 1200px) {
         ...
         @media (max-width: 992px) {
             .sidebar {
              ...
              .sidebar nav ul li a,
              .sidebar .logout-section .btn { justify-content: center; } 
              .sidebar nav ul li a i,
              .sidebar .logout-section .btn i { margin-right: 0; } 
        ...
        @media (max-width: 768px) {
            ...
            .sidebar .logo {
                ...
                padding: 0;
                 & span { display: inline; } /* Show text again */
            }
             .sidebar nav { display: none; } /* Hide nav completely on small mobile */
            .sidebar .logout-section {
                margin-top: 0;
                 padding: 0;
            }
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav>
            <ul>
                ...
                <li><a href="{{ route('restaurant.dashboard') }}"><i class="fas fa-receipt"></i> <span>Pesanan Baru</span></a></li> 

              
                <li><a href="{{ route('history') }}" class="active"><i class="fas fa-history"></i> <span>Riwayat</span></a></li> {{-- Route yang benar dan aktif --}}

            </ul>
        </nav>
        <div class="logout-section">
            
             <form action="{{ route('restaurant.logout') }}" method="POST" style="margin:0;"> {{-- Sesuaikan route logout --}}
                 @csrf
    ...
    <div class="main-content">
        ...
        <div class="header">
            ...
            <h1><i class="fas fa-history"></i> History Order {{ $restaurant->name ?? '' }}</h1>
                 ...
                 <div class="order-card-footer">
                      ...
                      @php
                          ...
                          if ($status === 'completed') {
                              ...
                              $statusIcon = 'fas fa-times-circle'; // Ikon silang
                          }
                      ...
                      <div class="text-xl font-bold text-gojek-green">
                          Rp {{ number_format($order->payment_total, 0, ',', '.') }}
                      </div>
                 </div>
            </div>
        @empty
            ...
            <div class="alert alert-info">
                <i class="fas fa-history"></i> There is no history of orders that have been completed or canceled.
            </div>
        @endforelse
